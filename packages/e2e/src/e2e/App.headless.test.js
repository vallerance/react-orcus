...
var assert =
        require('../../../shared/testing/src/lib/extendedChai.util').assert,
...
var renderApp = function (...args) {
    ...
    simulateDrag = function (
        elem,
        { left: startLeft = 0, top: startTop = 0 },
        { left: endLeft = 100, top: endTop = 100 },
        steps = 5
    ) {
        //calculate step
        var moveStep = {
...
describe('<App /> in browser should render', function () {
    ...
    describe('App that', function () {
        ...
        it('Has the correct size and position', function () {
            var [testLeft, testTop, testWidth, testHeight] =
                    extraProps.initialPosition,
                //get wrapper pos
