...
var renderApp = function (...args) {
    ...
    var desktopId = 'mounted-desktop',
        mountedDesktop = reactDomInstance.findInstance(
            jQuery(
                rtl.render(h(Desktop, { id: desktopId }, h(...args))).container
            )
                .find('#' + desktopId)
                .get(0)
        );
    ...
    return rtl.render(
        h(Provider, { store: mountedDesktop.reduxStore }, h(...args))
    );
};
...
describe('<App /> should render', function () {
    ...
    describe('App with', function () {
        it('Library class names', function () {
            assert.lengthOf(
                appWrapper.find('.orcus-app'),
                1,
                'Missing node with orcus-app class'
            );
            assert.lengthOf(
                appWrapper.find('.orcus-window'),
                1,
                'Missing node with orcus-window class'
            );
        });

        it('Resize handles', function () {
            assert.lengthOf(
                appWrapper.find('.orcus-resize-handle.top'),
                3,
                'Missing 3 nodes with .orcus-resize-handle.top class'
            );
            assert.lengthOf(
                appWrapper.find('.orcus-resize-handle.right'),
                3,
                'Missing 3 nodes with .orcus-resize-handle.right class'
            );
            assert.lengthOf(
                appWrapper.find('.orcus-resize-handle.bottom'),
                3,
                'Missing 3 nodes with .orcus-resize-handle.bottom class'
            );
            assert.lengthOf(
                appWrapper.find('.orcus-resize-handle.left'),
                3,
                'Missing 3 nodes with .orcus-resize-handle.left class'
            );
            assert.lengthOf(
                appWrapper.find('.orcus-resize-handle.top.right'),
                1,
                'Missing node with .orcus-resize-handle.top.right class'
            );
            assert.lengthOf(
                appWrapper.find('.orcus-resize-handle.bottom.right'),
                1,
                'Missing node with .orcus-resize-handle.bottom.right class'
            );
            assert.lengthOf(
                appWrapper.find('.orcus-resize-handle.bottom.left'),
                1,
                'Missing node with .orcus-resize-handle.bottom.left class'
            );
            assert.lengthOf(
                appWrapper.find('.orcus-resize-handle.top.left'),
                1,
                'Missing node with .orcus-resize-handle.top.left class'
            );
        });

        it('Transfered class name', function () {
            assert.include(
                appWrapper.find('.orcus-app').get(0).className,
        ...
        it('Other transfered props', function () {
            assert.equal(
                appWrapper.find('.orcus-app').eq(0).data('prop'),
    ...
    describe('Focused state', function () {
        var focusedWrapper = null,
            render = function (initialFocused = []) {
                ...
                destroyAppsWrapper();
                // render again
                var initialFocused = Object.assign(
                    ...
                    renderResult = rtl.render(
                        h(Desktop, Object.assign({}, extraProps), [
                            h(
                                App,
                                Object.assign({}, reqPropsOpened, {
                                    initialFocused: initialFocused[0],
                                    id: 'first-app',
                                    slug: 'first-app',
                                })
                            ),
                            h(
                                App,
                                Object.assign({}, reqPropsOpened, {
                                    initialFocused: initialFocused[1],
                                    id: 'second-app',
                                    slug: 'second-app',
                                })
                            ),
                            h(
                                App,
                                Object.assign({}, reqPropsOpened, {
                                    initialFocused: initialFocused[2],
                                    id: 'third-app',
                                    slug: 'third-app',
                                })
                            ),
                            h(
                                App,
                                Object.assign({}, reqPropsOpened, {
                                    initialFocused: initialFocused[3],
                                    id: 'fourth-app',
                                    slug: 'fourth-app',
                                })
                            ),
        ...
        it('That updates when app is clicked', async () => {
            ...
            testDom.click(focusedWrapper.find('#second-app').get(0));
            //second app should be focused
            await waitFor(() =>
                testDom.assertFocused(focusedWrapper, '#second-app')
            );
            ...
            testDom.click(focusedWrapper.find('#fourth-app').get(0));
    ...
    describe('Title bar with', function () {
        ...
        describe('Window controls section that has', function () {
            ...
            it('Initial control buttons', function () {
                assert.lengthOf(
                    titleBarWrapper.find(
                        '.orcus-controls .orcus-ui.orcus-button.orcus-minimize'
                    ),
                    1,
                ...
                assert.lengthOf(
                    titleBarWrapper.find(
                        '.orcus-controls .orcus-ui.orcus-button.orcus-maximize'
                    ),
                    1,
                ...
                assert.lengthOf(
                    titleBarWrapper.find(
                        '.orcus-controls .orcus-ui.orcus-button.orcus-close'
                    ),
                    1,
                ...
                it('Closes the app', function () {
                    ...
                    rtl.fireEvent.click(
                        jQuery(renderResult.container.firstChild)
                            .find(
                                '.orcus-title-bar .orcus-ui.orcus-button.orcus-close'
                            )
                            .get(0)
                    );
                ...
                it('Focuses app directly beneath it', function () {
                    ...
                    testFocusReplacement(function (wrapper, selector) {
                        ...
                        testDom.click(
                            wrapper
                                .find(
                                    `${selector} .orcus-title-bar .orcus-ui.orcus-button.orcus-close`
                                )
                                .get(0)
                        );
                    });
            ...
            describe('Minimize button that', function () {
                it('Minimizes the app', function () {
                    ...
                    rtl.fireEvent.click(
                        titleBarWrapper
                            .find(
                                '.orcus-title-bar .orcus-ui.orcus-button.orcus-minimize'
                            )
                            .get(0)
                    );
                ...
                it('Focuses app directly beneath it', function () {
                    ...
                    testFocusReplacement(function (wrapper, selector) {
                        ...
                        testDom.click(
                            wrapper
                                .find(
                                    `${selector} .orcus-title-bar .orcus-ui.orcus-button.orcus-minimize`
                                )
                                .get(0)
                        );
                    });
            ...
            it('Restore button if maximized', function () {
                ...
                rtl.fireEvent.click(
                    titleBarWrapper
                        .find(
                            '.orcus-title-bar .orcus-ui.orcus-button.orcus-maximize'
                        )
                        .get(0)
                );
                ...
                assert.lengthOf(
                    titleBarWrapper.find(
                        '.orcus-title-bar .orcus-ui.orcus-button.orcus-restore'
                    ),
                    1,
