...
describe('<Desktop /> should render taskbar', function () {
    ...
    it('With class names', function () {
        ...
        assert.lengthOf(
            taskbarWrapper.find('.orcus-taskbar .orcus-shortcuts'),
            1,
    ...
    describe('That', function () {
        ...
        describe('Shows which app is focused', function () {
            ...
            it('When two apps are open', function () {
                ...
                assert.lengthOf(
                    appsWrapper.find(
                        '#orcus-taskbar-shortcut-first-app.active'
                    ),
                    1,
            ...
            it('When apps are closed and re-opened', function () {
                ...
                rtl.fireEvent.dblClick(
                    appsWrapper
                        .find('#orcus-desktop-shortcut-second-app')
                        .get(0)
                );
                // second app should be active in taskbar
                assert.lengthOf(
                    appsWrapper.find(
                        '#orcus-taskbar-shortcut-second-app.active'
                    ),
                    1,
                    'Missing node with active class'
                );
        ...
        describe('For every open app has a shortcut that', function () {
            ...
            beforeEach(function () {
                ...
                appsWrapper = context.appsWrapper = jQuery(
            ...
            it('Focuses app when clicked', function () {
                ...
                testDom.click(
                    appsWrapper
                        .find('#orcus-taskbar-shortcut-fourth-app')
                        .get(0)
                );
